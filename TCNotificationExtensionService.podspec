...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TCNotificationExtensionService.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/freddyzeng/TCNotificationExtensionService'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'freddyzeng' => 'fanrong@addcn.com' }
  s.source           = { :git => 'https://github.com/freddyzeng/TCNotificationExtensionService.git', :tag => s.version.to_s }
